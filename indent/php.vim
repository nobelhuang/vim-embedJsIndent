...
setlocal indentexpr=GetPhpComIndent()
...
" By Nobel
"
" Indent combined for both PHP and JavaScript in PHP
function! GetPhpComIndent()
	if exists("*GetJavascriptIndent")
		let jind = GetJavascriptIndent()
		if jind != 0 && jind != -1
			return jind
		endif
	endif
